...
function button1() {
  ...
  <tr>
    ...
    list.innerHTML = `<label for="item">What Items do you need:</label>
    <select id="item">
  ...
  function button2() {
    ...
    <td>4</td>
      ...
      list2.innerHTML = `<label for="item">What Items do you need: </label>
      <select id="item">
        <option value="">--Make a choice--</option>
        <option value="tank">Tank</option>
        <option value="heater">Heater</option>
  ...
  function button3() {
    ...
    <td>6</td>
      ...
      list3.innerHTML = `<label for="item">What Items do you need: </label>
      <select id="item">
        <option value="">--Make a choice--</option>
        <option value="tank">Tank</option>
        <option value="heater">Heater</option>
...
function button1() {
  ...
  function button4() {
    ...
    <td>2</td>
      ...
      list4.innerHTML = `<label for="item">What Items do you need: </label>
      <select id="item">
        <option value="">--Make a choice--</option>
        <option value="tank">Tank</option>
        <option value="heater">Heater</option>
      ...
      function setitem3() {
        ...
        if (choice === 'tank') {
          para.innerHTML = `<a href="https://amzn.to/2XX8n7x" target="_blank">Tank</a>`;
        } else if (choice === 'heater') {
          para.innerHTML = `<a href="https://amzn.to/3lPxv80" target="_blank">Heater</a>`;
        } else if (choice === 'filter') {
          para.innerHTML = `<a href="https://amzn.to/3AEWgu5" target="_blank">Filter</a>`;
        } else {
          para.textContent = '';
        }
      }
